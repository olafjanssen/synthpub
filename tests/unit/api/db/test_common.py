...
from src.api.db.common import get_base_db_path, get_db_path
...
def test_get_base_db_path_from_settings(mock_settings):
    ...
    with patch("src.api.db.common.load_settings", return_value=mock_settings):
...
def test_get_base_db_path_from_env():
    ...
    with patch("src.api.db.common.load_settings", return_value={}):
...
def test_get_db_path():
    ...
    with patch("src.api.db.common.get_base_db_path", return_value=Path("/base/path")):
